...
- `testing\regression_test\kundtjanst-english-translation-consistency.md` - Manuellt/shared-browser-regressionstest som granskar alla Kundtjänst-/CSC-menyer och sidor i stage för engelsk översättning och konsekvent terminologi.
